### [INTRODUCTION](https://github.com/sz3/cimbar) | [ABOUT](https://github.com/sz3/cimbar/blob/master/ABOUT.md) | CFC | [LIBCIMBAR](https://github.com/turtleSST/libcimbar)
...
The app reads animated [cimbar codes](https://github.com/turtleSST/libcimbar). Nearly all the interesting logic is from libcimbar -- included via a git subtree.
...
The bundled WebView encoder uses the Fountain v2 assets from [turtleSST/cimbar-js-bits](https://github.com/turtleSST/cimbar-js-bits).
